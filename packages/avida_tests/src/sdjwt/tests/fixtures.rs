...
use avida_sdjwt_verifier::contract;
use avida_sdjwt_verifier::msg::InstantiateMsg;
use avida_sdjwt_verifier::types::InitRegistration;
...
pub fn default_instantiate_verifier_contract(
    ...
    let contract = verifier_contract();
